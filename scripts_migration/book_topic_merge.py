...
def main():
    ...
    if skipped_db1 > 0:
        print(f"[WARN] Skipping {skipped_db1} incomplete entries in DB1 (missing TopicID)")
    if skipped_db2 > 0:
        print(f"[WARN] Skipping {skipped_db2} incomplete entries in DB2 (missing TopicID)")
