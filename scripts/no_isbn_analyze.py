...
def main():
    ...
    print(f"{'Title + Publisher':<30} {len(title_pub):>10} {len(title_pub)/total*100:>11.1f}%")
    print(f"{'Title + Shelf':<30} {len(title_shelf):>10} {len(title_shelf)/total*100:>11.1f}%")
    print(f"{'Title + Publisher + Shelf':<30} {len(title_pub_shelf):>10} {len(title_pub_shelf)/total*100:>11.1f}%")
    print(f"{'Title ONLY (no pub/shelf)':<30} {len(title_only):>10} {len(title_only)/total*100:>11.1f}%")
